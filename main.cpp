...
void drawlargestring(int x, int y, char *s)
{
	char *c;
	glRasterPos2i(x, y);
	for (c = s; *c != '\0'; *c++)
...
void page()
{
	...
	drawlargestring(125, 420, "ANIMATION DEPICTING A ROCKETSHIP TAKEOFF! ");
    //Underline to the heading
	glBegin(GL_LINES);
        glVertex2d(125,415);
        glVertex2d(310,415);
    glEnd();
	...
	drawstring(85, 380, "INSTRUCTIONS: ");
	drawstring(135, 380, "1. Press I to Initiate");
	drawstring(135, 360, "2. Press L to Launch Pad");
	drawstring(135, 340, "3. Press Q to quit");
	...
	drawstring(230, 380, "Subject: Computer Graphics and Visualization");
	drawstring(230, 360, "Subject Code: 18CS62");
	drawstring(230, 340, "Subject Teacher: Prof. Shankar R.");
	...
	drawstring(200, 175, "NAME : Roy George");
	drawstring(200, 150, "USN : 1BY18CS126");
	drawstring(200, 125, "SEM : VI");

	drawstring(300, 175, "NAME : S. Geetanjali");
	drawstring(300, 150, "USN : 1BY18CS129");
	drawstring(300, 125, "SEM : VI");
...
int main(int argc,char*argv[])
{
	...
	glutCreateWindow("Rocket ship animation!");
	myinit();
